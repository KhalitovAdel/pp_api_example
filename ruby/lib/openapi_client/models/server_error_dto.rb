...
module OpenapiClient
  class ServerErrorDto
    ...
    def valid?
      ...
      status_code_validator = EnumAttributeValidator.new('Float', [500])
      return false unless status_code_validator.valid?(@status_code)
      return false if @code.nil?
      code_validator = EnumAttributeValidator.new('String', ["INTERNAL_ERROR"])
    ...
    def status_code=(status_code)
      validator = EnumAttributeValidator.new('Float', [500])
