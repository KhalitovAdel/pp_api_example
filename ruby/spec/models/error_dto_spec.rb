...
# Unit tests for OpenapiClient::ErrorDto
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe OpenapiClient::ErrorDto do
  let(:instance) { OpenapiClient::ErrorDto.new }

  describe 'test an instance of ErrorDto' do
    it 'should create an instance of ErrorDto' do
      expect(instance).to be_instance_of(OpenapiClient::ErrorDto)
    end
  end
  ...
  describe 'test attribute "status_code"' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('Float', [400, 401, 404, 500])
